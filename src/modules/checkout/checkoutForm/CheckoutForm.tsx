            ...
            <div className="well-bs col-md-12 full-page no-padding-top">
                <div className="white-box no-margin-top">
                    <div className="checkout ">
                        ...
                        <Form>
                            <FormGroup controlId="card" validationState={this.getCardNumberValidationState()}>
                            ...
                            <div className="form-row">
                                ...
                                <FormGroup className="ccv" controlId="ccv">
